...
export async function generateSectionContent(
  ...
  try {
    ...
    const systemPrompt = `You are an EU AI Act compliance expert helping organizations create documentation as required by the EU AI Act (Regulation 2024/1689).
...
- Acknowledge limitations or areas requiring additional information from the organization`
    ...
    const userPrompt = `Generate content for the "${sectionTitle}" section (${articleReference}).
